...
Example_Filter.m      demonstrates construction and usage of a gammatone filter
                      as described in section 2.3 of the article
...
Another implementation of the Gammatone filter can be found in the file
"Gfb_analyze.c", where it is part of the C extension that implements filterbank
analysis.
...
(A)
Filter parameter calculation as in section 2.3 of the article requires five
arguments:
...
(B)
Filter parameter calculation as in section 3 (equations 13,14) of the article
...
(among others):
  ...
  filters                -  a row vector of "Gfb_Filter" structures,
                            ...
                            state (when using octave, this field is a struct
                            itself, and contains the filter structs)
...
The synthesizer consists of a channel-dependent delay line and a mixer, thus
