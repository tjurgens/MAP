...
for channel = 1:channels
  fprintf(1,'%3d|%7d | %9f + %9fi | %5.2f\n', ...
	  channel,                            ...
	  delay.delays_samples(channel),      ...
	  real(delay.phase_factors(channel)), ...
	  imag(delay.phase_factors(channel)), ...
	  20*log10(mixer.gains(channel)));
end
