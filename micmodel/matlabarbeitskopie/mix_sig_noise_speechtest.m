function mix_sig_noise_speechtest(snr,cdir,zieldir)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% vermischt signal und rauschen im angegebenen snr
% input: snr: signalrauschverh‰ltnis
...
for i = 1:nFiles,
    ...
    %% signal skalieren
    signal = signal./speechfactor;  % bringe signal auf rms = 1;
    signal = signal./128;  %abschw‰chung dies ist die Referenz: der Sprachpegel.
