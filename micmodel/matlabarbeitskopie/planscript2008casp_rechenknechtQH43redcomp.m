...
tic
speaker = 'S02M';
pcondition.audiogram = [10 10 10 15 15 20 25 30 40 55 60];
...
% 
for i = 1:10   %ca.16std.
   workingdirectory = ['/home/tim/modelidenticalCASPhiQH43lorentzreducedcompression/daten/identicalrunninglorentz' num2str(i) '/S02M_NO/'];
   cd(workingdirectory);
    backnoiseshift = i;
