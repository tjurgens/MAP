...
for i = 1:1   %ca.16std.
    workingdirectory = ['D:\tim\2006-2007\modelidenticalJASALorentz\daten\testesttotalunterschiedlichbeitemplatesallegleichidenticalrunninglorentz' num2str(i) '\S02M_NO\'];
    cd(workingdirectory);
