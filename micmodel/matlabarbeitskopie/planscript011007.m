...
% for i = 1:1 % % %%%%%%%%%%%%%zuerst nonidentical workingdirectory =
% ['d:\tim\S02M_NOtestesttotalunterschiedlichbeitemplatesallegleichnonident
% icallorentz' num2str(i) '\']; cd(workingdirectory);
% 
% % % %%%%%%% erster block 0 dB SNR %%%%%%%%%%%%%%% % pcondition.noiselevel
% = 60; pcondition.speechlevel = 60; % % % cd(workingdirectory);
% %make_all_vocabulary_mfb('S02M_NO',pcondition);
% recognizeall_mfb('S02M_NO',pcondition,'normal_auswahl'); %
% recognizeall('S02M_NO',pcondition,'rand_var_auswahl_2'); [BIG_CM,
% hitrate] = sumup_cm('S02M_NO',pcondition); % % % 
...
for i = 1:1
    ...
    %     end
    workingdirectory = ['D:\tim\sprecherin1distancevalues\S01F_NO\'];
    ...
    cd(workingdirectory);
        ...
        % %%%%%%% vierter block 0 dB SPL %%%%%%%%%%%%%%%
        pcondition.noiselevel = 40;
        pcondition.speechlevel = 60;

        %
        cd(workingdirectory);
        make_all_vocabulary_mfb('S01F_NO',pcondition);
        recognizeall_mfb('S01F_NO',pcondition,'normal_auswahl');
        % recognizeall('S02M_NO',pcondition,'rand_var_auswahl_2');
        [BIG_CM, hitrate] = sumup_cm('S01F_NO',pcondition);
