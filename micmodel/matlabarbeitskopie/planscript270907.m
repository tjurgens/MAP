...
for i = 1:1
    ...
    %     end
    workingdirectory = ['D:\tim\modelidenticalJASALorentz\daten\testesttotalunterschiedlichbeitemplatesallegleichidenticalrunninglorentz' num2str(i) '\S02M_NO'];
