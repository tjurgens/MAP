function method=MAPparamsATyleft...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. High-frequency dead region from 6500 Hz onwards
%  2. Very slight reduction of DRNLParams.a at low frequencies
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
DRNLParams.a=[repmat(2e4,1,13) repmat(5e4,1,length(BFlist-13))];       % DRNL.a=0 means no OHCs (no nonlinear path)
