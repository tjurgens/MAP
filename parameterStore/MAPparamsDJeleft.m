function method=MAPparamsDJeleft ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. IHC_cilia_RPParams.Et is reduced to 82 mV
%  2. Dead high-frequency region (from 5500 Hz onwards)
%  3. DRNLParams.a is reduced at low frequencies
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
DRNLParams.a=[repmat(1.5e3,1,13) repmat(1e4,1,22-13) repmat(5e4,1,length(BFlist)-22)];       % DRNL.a=0 means no OHCs (no nonlinear path)
...
IHC_cilia_RPParams.Et=	0.082;          % endocochlear potential (V)
