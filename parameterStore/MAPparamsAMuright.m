function method=MAPparamsAMuright ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. IHC_cilia_RPParams.Et is reduced to 72 mV
%  2. Dead high-frequency region from 3800 Hz onwards
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
availableBFlist = availableBFlist(1:32);
if size(BFlist) == 1
...
IHC_cilia_RPParams.Et=	0.072;          % endocochlear potential (V)
