function method=MAPparamsNormalA ...
...
DRNLParams.MOCtau =.05;                         % smoothing for MOC
DRNLParams.rateToAttenuationFactor = .008;  % strength of MOC
...
IHC_cilia_RPParams.C=	0.3;       % 0.1 scalar (C_cilia ) 
