function method=MAPparamsHBoright ...
...
DRNLParams.a=[repmat(2e3,1,13) repmat(5e3,1,29-13) repmat(5e4,1,length(BFlist-29))];       % DRNL.a=0 means no OHCs (no nonlinear path)
