function method=MAPparamsMNoleft ...
...
availableBFlist = availableBFlist(1:14);
if size(BFlist) == 1
...
IHC_cilia_RPParams.Et=	0.063;%0.100;          % endocochlear potential (V)
