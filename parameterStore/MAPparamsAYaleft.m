function method=MAPparamsAYaleft ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. IHC_cilia_RPParams.Et is reduced to 78 mV
%  2. Dead mid-frequency region (1800 Hz to 3000 Hz)
%  3. Dead high-frequency region (from 7000 Hz onwards)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
availableBFlist = [availableBFlist(1:24) availableBFlist(30:39)];
if size(BFlist) == 1
...
IHC_cilia_RPParams.Et=	0.078;          % endocochlear potential (V)
