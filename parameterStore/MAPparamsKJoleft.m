function method=MAPparamsKJoleft ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. IHCciliaParams.Et is reduced to 87mV
%  2. High-frequency dead region (from 6000 Hz onwards)
...
availableBFlist = [availableBFlist(1:36) 5850];
if size(BFlist) == 1
...
%%  #3 DRNL
DRNLParams.a=[repmat(5e3,1,6) repmat(1e4,1,12-6) repmat(5e4,1,length(BFlist)-12)];  % clear the structure first
