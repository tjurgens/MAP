function method=MAPparamsKSeleft ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. IHCciliaParams.Et is reduced to 85mV
...
%%  #3 DRNL
DRNLParams.a=[repmat(2e3,1,12) repmat(1e4,1,15-12) repmat(5e4,1,length(BFlist)-15)];  % clear the structure first
