...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. DRNLParams.a is frequency-dependent reduced
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
DRNLParams.a = [repmat(2e4,1,8) repmat(5e3,1,25-8) repmat(1e4,1,35-25) repmat(5e2,1,41-35)];
