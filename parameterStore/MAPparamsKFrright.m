function method=MAPparamsKFrright ...
...
availableBFlist = [availableBFlist(1:7) availableBFlist(29:35)];
...
DRNLParams.a=2e4;%5e4;       % DRNL.a=0 means no OHCs (no nonlinear path)
...
%   *** DRNL linear path:
DRNLParams.g=50;       % linear path gain factor
