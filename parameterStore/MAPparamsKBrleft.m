function method=MAPparamsKBrleft ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. IHCciliaParams.Et is reduced to 82mV
...
%%  #3 DRNL
DRNLParams.a=[repmat(5e3,1,25) repmat(5e4,1,length(BFlist)-25)];  % clear the structure first
