...
OMEParams.rateToAttenuationFactor=0;%0.006;   % * N(all ICspikes)
...
DRNLParams.rateToAttenuationFactor = 0;%.01;  % strength of MOC
%      DRNLParams.rateToAttenuationFactor = 0;  % strength of MOC
% 'probability' model: MOC based on AN spiking activity (HSR)
DRNLParams.rateToAttenuationFactorProb = 0;%0.012;  % strength of MOC
