function method=MAPparamsDPeleft ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. IHCciliaParams.Et is reduced to 67 mV
...
availableBFlist = [availableBFlist(7:16) availableBFlist(24:30)];
if size(BFlist) == 1
...
IHC_cilia_RPParams.Et=	0.067;%0.100;          % endocochlear potential (V)
