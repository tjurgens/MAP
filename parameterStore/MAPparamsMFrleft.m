function method=MAPparamsMFrleft ...
...
availableBFlist = [availableBFlist(1:21) availableBFlist(30:32)];
if size(BFlist) == 1
...
DRNLParams.a=250;       % DRNL.a=0 means no OHCs (no nonlinear path)
