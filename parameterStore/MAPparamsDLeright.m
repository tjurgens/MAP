function method=MAPparamsDLeright ...
...
%  2. Dead high-frequency region (from 4000 Hz onwards), but one channel at
%     7000 Hz remains
...
availableBFlist = [availableBFlist(1:32) 7000];
if size(BFlist) == 1
...
DRNLParams.a=[repmat(1e4,1,18) repmat(5e4,1,length(BFlist)-18)];       % DRNL.a=0 means no OHCs (no nonlinear path)
