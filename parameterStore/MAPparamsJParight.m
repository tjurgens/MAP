function method=MAPparamsJParight ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  HYPOTHESIS
%  1. Dead high-frequency region above 6000 Hz
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
availableBFlist = availableBFlist(1:37);
if size(BFlist) == 1
...
DRNLParams.a=5e4;%[repmat(2e3,1,13) repmat(5e3,1,29-13) repmat(5e4,1,length(BFlist-29))];       % DRNL.a=0 means no OHCs (no nonlinear path)
