...
gapRelativeBandWidth = stimulusParameters.gapRelativeBandWidth;
    ...
    otherwise
        ...
        switch experiment.paradigm
            ...
            case {'training','absThreshold', 'absThreshold_8',  ...
                    ...
                    'OHIOrand', 'OHIOtemp', 'OHIOspectemp','notchednoise'}
...
stimComponents(targetEar,componentNo).notchwidth=gapRelativeBandWidth;
