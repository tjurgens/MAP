...
for i=1:length(variableNames)
    if strcmp(variableNames{i},'gapRelativeBandWidth')
        cmd=(['set(handles.edit' 'gapDuration' ...
...
if strcmp(experiment.paradigm,'notchednoise')
    set(handles.textgapDuration,'string','notchRelativeBW')
else
    set(handles.textgapDuration,'string','gapDuration')
end
...
%workaround for notched noise paradigm
if isfield(stimulusParameters,'probetimeinNN')
    eval(stimulusParameters.probetimeinNN);
end
stimulusParameters.gapRelativeBandWidth = str2num(get(handles.editgapDuration,'string'));
...
stimulusParameters.gapRelativeBandWidth = [];
