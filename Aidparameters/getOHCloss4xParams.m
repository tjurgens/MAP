function [ UNIQUEpars, SHAREDpars ] = getOHCloss4xParams(  )
...
% 
 for nn = 0:SHAREDpars.NumBands-1 %Channels are indexed from zero!
     ...
     eval(['SHAREDpars.Band_' num2str(nn) '_MOCthreshold_dBspl = 5;']);%10
 end
 
%  SHAREDpars.Band_0_MOCthreshold_dBspl = 5;
%  SHAREDpars.Band_1_MOCthreshold_dBspl = 5;
%  SHAREDpars.Band_2_MOCthreshold_dBspl = 0;
%  SHAREDpars.Band_3_MOCthreshold_dBspl = 2.5;
%  SHAREDpars.Band_4_MOCthreshold_dBspl = 5;
%  SHAREDpars.Band_5_MOCthreshold_dBspl = 10;
%  SHAREDpars.Band_6_MOCthreshold_dBspl = 15;
%  SHAREDpars.Band_7_MOCthreshold_dBspl = 17.5;
%  SHAREDpars.Band_8_MOCthreshold_dBspl = 20;
...
for nn = 0:SHAREDpars.NumBands-1 %Channels are indexed from zero!    
    eval(['UNIQUEpars.Band_' num2str(nn) '_InstantaneousCmpThreshold_dBspl  = 50;']);
    eval(['UNIQUEpars.Band_' num2str(nn) '_DRNLc = 0.2;']);       
    eval(['UNIQUEpars.Band_' num2str(nn) '_Gain_dB  =  30.0;']);
end
