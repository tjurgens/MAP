function [ UNIQUEpars, SHAREDpars ] = getOHCloss4jParams(  )
...
% 
 for nn = 0:SHAREDpars.NumBands-1 %Channels are indexed from zero!
     ...
     eval(['SHAREDpars.Band_' num2str(nn) '_MOCthreshold_dBspl = 200;']);%10
 end
...
%  SHAREDpars.Band_5_MOCthreshold_dBspl = 10;  %2000
%  SHAREDpars.Band_6_MOCthreshold_dBspl = 10;
%  SHAREDpars.Band_7_MOCthreshold_dBspl = 10;
%  SHAREDpars.Band_8_MOCthreshold_dBspl = 10;
