function Experiment3MFCCs(isMasterNode)
...
xL.numWavs = 6000;%1000; %10;%MAX=8440
...
xL.noiseName = '1babble';%'6whitenoise';'5reallyflatpinknoise';%'4modulatedpinknoise';%'3flatnarrowbabble';%'2flatbabble'; %1babble
