function outsignal = cutsignal_aurora(insignal,samplingfrequency,vocabularyset)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
initial_threshold = 0.15*max(abs(insignal)); %amplitude threshold for detection of speech
final_threshold = 0.1*max(abs(insignal));
